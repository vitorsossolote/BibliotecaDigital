  ...
  return (
    <NavigationContainer>
      <Tab.Navigator initialRouteName="Home"
        ...
        <Tab.Screen name="LoanHistory" component={LoanHistory} options={{ headerShown: false,  tabBarButton: (props) => null, tabBarStyle:{display:'none'}}}/>
        <Tab.Screen name="SearchAuthorScreen" component={SearchAuthorScreen} options={{ headerShown: false,  tabBarButton: (props) => null, }}/>
        <Tab.Screen name="SearchGenderScreen" component={SearchGenderScreen} options={{ headerShown: false,  tabBarButton: (props) => null, }}/>
        <Tab.Screen name="SearchScreen" component={SearchScreen} options={{ headerShown: false,  tabBarButton: (props) => null, }}/>
